...
public:
    ...
    Field	Columns	Content	                                                                    Example
        ...
        11	54–61	B*, the drag term, or radiation pressure coeff (decimal point assumed) [12]	-11606-4
        12	63–63	Ephemeris type (always zero; only used in undistributed TLE data) [13]	    0
        13	65–68	Element set number. Incremented when new TLE is generated for object. [12]	292
